...
class Ui_Calcultor(object):
    ...
    def retranslateUi(self, Calcultor):
        ...
        self.pushButton_17.setText(_translate("Calcultor", "±"))
        self.pushButton_18.setText(_translate("Calcultor", "%"))
        self.pushButton_19.setText(_translate("Calcultor", "/"))


class Example(QMainWindow, Ui_Calcultor):
    def __init__(self):
        super(Example, self).__init__()
        self.setupUi(self)
        self.setWindowIcon(QtGui.QIcon('icon/calk_icon.ico'))

        self.text, self.text2 = "", ""

        self.pushButton_12.clicked.connect(self.push_eq)
        self.pushButton_16.clicked.connect(self.clear)

        self.pushButton.clicked.connect(self.add_sign)
        self.pushButton_2.clicked.connect(self.add_sign)
        self.pushButton_3.clicked.connect(self.add_sign)
        self.pushButton_4.clicked.connect(self.add_sign)
        self.pushButton_5.clicked.connect(self.add_sign)
        self.pushButton_6.clicked.connect(self.add_sign)
        self.pushButton_7.clicked.connect(self.add_sign)
        self.pushButton_8.clicked.connect(self.add_sign)
        self.pushButton_9.clicked.connect(self.add_sign)
        self.pushButton_10.clicked.connect(self.add_sign)
        self.pushButton_11.clicked.connect(self.add_sign)
        self.pushButton_13.clicked.connect(self.add_sign)
        self.pushButton_14.clicked.connect(self.add_sign)
        self.pushButton_15.clicked.connect(self.add_sign)
        self.pushButton_17.clicked.connect(self.add_sign)
        self.pushButton_18.clicked.connect(self.add_sign)
        self.pushButton_19.clicked.connect(self.add_sign)
    ...
    def push_eq(self):
        try:
            self.text = eval(self.text2 + self.text)
...
if __name__ == '__main__':
    ...
    app.setWindowIcon(QtGui.QIcon('icon/calk_icon.ico'))
    ex = Example()
    ex.show()
